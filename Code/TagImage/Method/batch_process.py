...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage : python3 batch_process.py nom_de_fonction.py dossier_sortie")
    else:
        script = sys.argv[1]
        folder = "../../../../../benjamin-serva/Extreme SSD/Film_Numalyse/Dataset_Plan_Q2_corrige/video_corrige"
        out = sys.argv[2]
        batch_process(script, folder, out)